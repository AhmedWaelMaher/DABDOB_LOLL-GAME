...
extern STD_Fun_t TIMER_Init (uint8 TimerSpecs);
extern STD_Fun_t TIMER_Start (uint8 TimerName, uint8 Prescaler_Conf);
extern STD_Fun_t TIMER_Stop (uint8 TimerName);
extern STD_Fun_t Timer_CreateTick(uint8 TimerID , uint16 resolution_ms);
extern STD_Fun_t Timer_Deinit(uint8 TimerName);
